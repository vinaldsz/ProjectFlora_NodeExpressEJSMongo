...
export async function getFarmerByHarvestId(harvest_id) {
...
export async function getFarmerByFarmerId(farmer_id) {
...
export async function deleteInventoryById(harvest_id, inventory) {
